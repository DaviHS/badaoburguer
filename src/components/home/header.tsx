        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-2">
            <div className="w-10 h-10 rounded-full flex items-center justify-center shadow-inner transition-all duration-500">
              <Image src="/logo-circle-white.png" alt="Logo" width={32} height={32} className="object-contain border-0 outline-none" />
            </div>
            <div className="block">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="relative flex items-center gap-2 bg-transparent border-white text-white hover:bg-white hover:text-[#4d0f2e] transition-colors hidden md:flex"
                >
              ...
              <DropdownMenuContent align="end" className="w-56">
                {!session?.user && (
                  <>
                    ...
                    <DropdownMenuItem asChild>
                      <a href="/sign-in" className="flex items-center gap-2 cursor-pointer">
          ...
          <div className="md:hidden py-4 border-t border-[#3a0b20]">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="border-t border-border pt-4 mt-4">
                ...
                {!session?.user && (
                  <>
                    <a href="/cadastro" className="text-gray-300 hover:text-primary flex items-center gap-2 mb-2" onClick={() => setIsMenuOpen(false)}>
                      <UserPlus className="h-4 w-4" /> Criar Conta
                    </a>
                    <a href="/sign-in" className="text-gray-300 hover:text-primary flex items-center gap-2 mb-2" onClick={() => setIsMenuOpen(false)}>
                      <LogIn className="h-4 w-4" /> Fazer Login
                    </a>
                  </>
                )}
